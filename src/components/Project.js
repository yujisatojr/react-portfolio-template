  ...
  return  (
    ...
    <FadeInSection>
      ...
      <div className="projects-grid">
        ...
        <div className="project">
          <a href="https://www.datumlearn.com/" target="_blank" rel="noreferrer"><img src={mock1} className="zoom" alt="thumbnail" width="100%"/></a>
        ...
        <div className="project">
          <a href="http://www.wemanage.jp/" target="_blank" rel="noreferrer"><img src={mock2} className="zoom" alt="thumbnail" width="100%"/></a>
        ...
        <div className="project">
          <a href="https://www.byuh.edu/covid-19-case-management" target="_blank" rel="noreferrer"><img src={mock3} className="zoom" alt="thumbnail" width="100%"/></a>
        ...
        <div className="project">
          <a href="https://github.com/yujisatojr/multi-reg-analysis" target="_blank" rel="noreferrer"><img src={mock7} className="zoom" alt="thumbnail" width="100%"/></a>
        ...
        <div className="project">
          <a href="https://github.com/yujisatojr/py-scraper" target="_blank" rel="noreferrer"><img src={mock8} className="zoom" alt="thumbnail" width="100%"/></a>
        ...
        <div className="project">
          <a href="https://holokai.byuh.edu/programs-of-study" target="_blank" rel="noreferrer"><img src={mock4} className="zoom" alt="thumbnail" width="100%"/></a>
