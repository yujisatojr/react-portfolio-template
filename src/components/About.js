    ...
    <div className="container" id="about">
      ...
      <div className="about-section">
        <div className="content">
          <h1>About Me</h1>
          <p>Hi👋 My name is Yuji. I am a self-motivated developer currently pursuing a bachelor's degree in computer science at Brigham Young University - Hawaii (Expected graduation 2022 April). My experience working in a various industries has helped me not only in becoming a engineer but also an effective leader, communicator, and marketer. Whenever I build, I strive to analyze it from a user's perspective and deliver a high-quality experience.</p>
          <p>Expertise: software development, frontend/backend web development, REST API, iOS/Android mobile applications development, data analysis, data visualization, and machine learning.</p>
