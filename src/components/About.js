    ...
    <div className="container" id="about">
      ...
      <div className="about-section">
        <div className="content">
          <h1>About Me</h1>
          <p>Hi! My name is Yuji. I am currently pursuing a bachelor's degree in computer science at Brigham Young University - Hawaii (Expected graduation 2022 April). I also work as a developer/analyst at my university's Enterprise Information Systems department, developing software for a diverse population of 3,200 students and faculty members. Throughout my career, I have always found it rewarding to understand the needs of each individual client and solve their problems through the use of emerging technology.</p>
